...
조금 사용해본 기술들
<br/>
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="65" height="20">
    ...
    <g clip-path="url(#a)">
        ...
        <path fill="#689f63" d="M25 0h40v20H25z"/>
    ...
    <g fill="#fff" text-anchor="middle" font-family="DejaVu Sans,Verdana,Geneva,sans-serif" font-size="12">
        ...
        <text x="44" y="14.6" fill="#010101" fill-opacity=".3">Node</text>
        <text x="44" y="14">Node</text>
    </g>
</svg>
